...
# logger
log_filename = datetime.now().strftime("output/densenet121-memory_train_%Y_%m_%d_%H_%M.log")
...
test_loader = DataLoader(dataset=test_dataset, batch_size=32, shuffle=False, num_workers=2, pin_memory=True)

# model
model = torch.hub.load('pytorch/vision:v0.9.0', 'densenet121', weights=None, num_classes=10)
...
lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(
                optimizer, len(train_loader)*50, eta_min=1e-6)
