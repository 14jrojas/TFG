...
# logger
log_filename = datetime.now().strftime("output/resnet101-memory_train_%Y_%m_%d_%H_%M.log")
...
# model
model = torch.hub.load('pytorch/vision:v0.9.0', 'resnet101', weights=None, num_classes=10)
